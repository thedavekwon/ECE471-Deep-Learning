...
def resnet(in_channels, n_classes, block=ResNetBottleNeckBlock, drop=False):
    if drop:
        return ResNet(
            ...
            n_classes,
            maxpool=True,
            block=ResNetBasicDropOutBlock,
            depths=[1, 1, 1, 1],
        )
    return ResNet(
        in_channels, n_classes, maxpool=True, block=block, depths=[1, 1, 1, 1]
    )
...
def resnet18(in_channels, n_classes, block=ResNetBasicBlock, drop=False):
    ...
    return ResNet(
        in_channels, n_classes, maxpool=True, block=block, deepths=[2, 2, 2, 2]
    )
...
def resnet50(in_channels, n_classes, block=ResNetBottleNeckBlock, drop=False):
    if drop:
        return ResNet(
            ...
            n_classes,
            maxpool=True,
            block=ResNetBottleNeckDropOutBlock,
            depths=[3, 4, 6, 3],
        )
    return ResNet(
        in_channels, n_classes, maxpool=True, block=block, deepths=[3, 4, 6, 3]
    )
...
def resnet101(in_channels, n_classes, block=ResNetBottleNeckBlock, drop=False):
    ...
    return ResNet(
        in_channels, n_classes, maxpool=True, block=block, depths=[3, 4, 23, 3]
    )
...
def resnet151(in_channels, n_classes, block=ResNetBottleNeckBlock, drop=False):
    ...
    return ResNet(
        in_channels, n_classes, maxpool=True, block=block, depths=[3, 8, 36, 3]
    )
